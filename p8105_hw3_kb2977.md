...
<img src="p8105_hw3_kb2977_files/figure-markdown_github/plot-1.png" width="100%" />
...
-   The user\_id with the most orders was
-   The item that was the most ordered was
-   The item that was the most reordered was
-   Customers tend to order on \_\_\_ day at around \_\_\_ time.

### Part 2: Answering questions using instacart\_data

1.  How many aisles are there, and which aisles are the most items ordered from? There were a total of 134 aisles.
...
1.  Make a table showing the most popular item in the aisles “baking ingredients”, “dog food care”, and “packaged vegetables fruits”

``` r
pop_item = instacart
```

1.  Make a table showing the mean hour of the day at which Pink Lady Apples and Coffee Ice Cream are ordered on each day of the week; format this table for human readers (i.e. produce a 2 x 7 table).
